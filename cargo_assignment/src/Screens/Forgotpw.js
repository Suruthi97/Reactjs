...
const Forgotpw = () => {
  ...
  return (
    <div className="row g-0 auth-wrapper">
      ...
      <div className="col-12 col-md-7 col-lg-6 auth-main-col text-center" style={{textAlign:"center",marginLeft:"400px",marginTop:"200px"}}>
          ...
          <div className="auth-body mx-auto">
            ...
            <div className="auth-form-container text-start" >
              <form 
                ...
                autoComplete={"off"}
              >
                <div className="email mb-3" style={{width:"400px"}}>
                  <input
                    type="email"
                    ...
                    name="email"
                    value={email}
                    placeholder="Email your registered EmailId"
